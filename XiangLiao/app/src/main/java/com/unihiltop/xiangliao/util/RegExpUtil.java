...
public class RegExpUtil {
	 ...
	 * 手机号码正则表达式
	 */
	public final static String REGEXP_PHONE = "^((14[0-9])|(13[0-9])|(15[0-9])|(17[0-9])|(18[0-9]))\\d{8}$";
	...
	public static final String  REGEXP_COMPANY_NAME = "^([\u4e00-\u9fa5]{2,30})$";
	
	/**
	 * 邮箱正则表达式
	 */
	public final static String REGEXP_PASSWORD = "^(?![^a-zA-Z]+$)(?!\\d+$).{8,16}$";
	/**
	 * 邮编正则表达式
	 */
	public static final String REGEXP_POST_CODE = "^(\\d){6}$";
	...
	public final static boolean match(String regexp,String str){
		if (TextUtils.isEmpty(regexp)||TextUtils.isEmpty(str)) {
			return false;
		}
		return str.matches(regexp);
	}
	
	public static String idCardValidate(String idString) throws Exception {
