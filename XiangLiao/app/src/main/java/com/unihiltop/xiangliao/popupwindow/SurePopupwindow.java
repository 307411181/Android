 ...
 */
public class SurePopupwindow extends PopupWindow implements View.OnClickListener, PopupWindow.OnDismissListener {
    ...
    public SurePopupwindow(Activity activity) {
        ...
        popView = inflater.inflate(R.layout.popupwindow_sure, null);
